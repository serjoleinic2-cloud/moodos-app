...
export function initOnboarding(onComplete) {
  ...
  // Показ Terms/Privacy
  function showTextModal(title, type) {
  ...
  function getPrivacyHTML() {
    return `
      ...
      <p>ideas@neyra-app.com<br><a href="http://neyra-app.com" style="color:#4a7c59;">neyra-app.com</a></p>
  ...
  function getTermsHTML() {
    return `
      ...
      <p>We may update these Terms from time to time. Continued use of the app means you accept the updated version. The latest version is always available at <a href="http://neyra-app.com" style="color:#4a7c59;">neyra-app.com</a></p>
