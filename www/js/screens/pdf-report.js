...
export function showPdfReportModal() {
  ...
  screen.style.cssText = "position:fixed;top:0;left:0;right:0;bottom:100px;z-index:50;background:linear-gradient(160deg,#d4ede8 0%,#e8e0d5 100%);overflow-y:auto;-webkit-overflow-scrolling:touch;";
  ...
  screen.innerHTML =
    ...
    '<div class="pr-wrap">' +
      ...
      '<button id="prBackBtn" style="width:100%;padding:15px;border:none;border-radius:16px;background:rgba(232,237,230,0.9);box-shadow:6px 6px 14px #b8c4b4,-6px -6px 14px #ffffff;font-size:15px;font-weight:700;color:#888;cursor:pointer;margin-top:8px;">' + (t('back') || '←') + '</button>' +
      '</div>' +
    '</div>';
