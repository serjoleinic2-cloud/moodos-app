        ...
        <div class="flip-wrap" id="flip-trend">
          <div class="flip-inner">
            <div class="flip-front">
              ...
              <div class="flip-value" style="font-size:22px;">${trend}</div>
              <div class="flip-sub">Последние записи vs предыдущие</div>
              <div class="flip-hint">Нажми для деталей ↩</div>
            </div>
            <div class="flip-back" style="flex-direction:column; gap:8px;">
              <div style="font-size:14px; color:#666; text-align:center;">${trendExplain(trend)}</div>
            </div>
          </div>
        </div>
        ...
        <div class="flip-wrap" id="flip-breathing">
          <div class="flip-inner">
            <div class="flip-front">
              ...
              <div class="flip-sub">
                ${breathingLift !== null ? `Средний подъём: +${breathingLift} pts` : "Нет данных"}
        ...
        <div class="flip-wrap" id="flip-meditation">
          <div class="flip-inner">
            <div class="flip-front">
              ...
              <div class="flip-sub">
                ${meditationLift !== null ? `Средний подъём: +${meditationLift} pts` : "Нет данных"}
...
function drawStabilityChart(history) {
  ...
  // Показываем скользящую стабильность по 5 записей
  const points = [];
...
function trendExplain(trend) {
  if (trend.includes("improving")) return "Последние записи лучше предыдущих. Ты на подъёме — продолжай в том же духе.";
  if (trend.includes("declining")) return "Последние записи ниже предыдущих. Возможно стоит уделить внимание практикам или отдыху.";
