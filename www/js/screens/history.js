  ...
  container.querySelectorAll(".voice-play-btn").forEach(btn => {
    btn.addEventListener("click", e => {
      ...
      if (btn._audio && !btn._audio.paused) {
        btn._audio.pause();
        if (btn) btn.innerHTML = '<img src="/icons/player/play.svg" style="width:18px;height:18px;" alt="▶">';
        return;
      }
      if (currentAudio && currentAudio !== btn._audio) {
        ...
        container.querySelectorAll(".voice-play-btn").forEach(b => {
          if (b._audio === currentAudio) {
            b.innerHTML = '<img src="/icons/player/play.svg" style="width:18px;height:18px;" alt="▶">';
          }
        });
      }
      if (!btn._audio) {
        ...
        audio.addEventListener("ended", () => {
          btn.innerHTML = '<img src="/icons/player/play.svg" style="width:18px;height:18px;" alt="▶">';
      ...
      btn.innerHTML = '<img src="/icons/player/pause.svg" style="width:18px;height:18px;" alt="⏸">';
    });
  });
