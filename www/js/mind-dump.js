...
export function initMindDump(container) {
    ...
    <div style="text-align:center; margin-top:20px;">
      ...
      <div id="mdActions" style="display:none;flex-direction:column;gap:10px;align-items:center;margin-bottom:16px;">
        ...
        <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap;">
          <div id="mdSave"   style="padding:12px 20px;border-radius:16px;cursor:pointer;background:#e0e5ec;box-shadow:5px 5px 10px #b8bec7,-5px -5px 10px #ffffff;color:#5a8dee;font-size:15px;">💾 Сохранить</div>
          <div id="mdDelete" style="padding:12px 20px;border-radius:16px;cursor:pointer;background:#e0e5ec;box-shadow:5px 5px 10px #b8bec7,-5px -5px 10px #ffffff;color:#e05555;font-size:15px;">🗑 Удалить</div>
        </div>
      </div>
      ...
      <div id="mdFeedback" style="display:none;flex-direction:column;gap:14px;align-items:center;margin-top:10px;">
        ...
        <div id="mdHelped" style="width:75%;padding:16px;border-radius:18px;cursor:pointer;background:#e0e5ec;box-shadow:6px 6px 12px #b8bec7,-6px -6px 12px #ffffff;color:#4a7c59;font-size:18px;text-align:center;">👍 Помогло</div>
        <div id="mdNotHelped" style="width:75%;padding:16px;border-radius:18px;cursor:pointer;background:#e0e5ec;box-shadow:6px 6px 12px #b8bec7,-6px -6px 12px #ffffff;color:#888;font-size:18px;text-align:center;">👎 Не помогло</div>
      </div>
  ...
  function stopSession() {
    ...
    textarea.disabled=true; mainBtn.innerText="▶"; status.textContent="Готово";
  }
